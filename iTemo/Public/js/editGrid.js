    ...
    Grid.prototype = {
        ...
        _eachFieldEditor: function ($row, callBack) {
            ...
            $cells.each(function (index, cell) {
                var $cell = $(cell);
                var field = $cell.data(EDITGRID_CELL_EDITOR_KEY);
                if (field != undefined && field.editing && field.visible) {
                    callBack.call(self, field, index);
                }
            });
        },
        ...
        _validateItem: function (row) {
            ...
            this._eachFieldEditor($row, function (field, index) {
                ...
                var errors = this._validation.validate($.extend({
                    value: $.trim(this._getItemFieldValue(item, field)),
...
(function (editGrid, $, undefined) {
    ...
    NumberField.prototype = new TextField({
        ...
        itemTemplate: function (value, item) {
            var $result = this._createTextBox();
            $result.autoNumeric('set', value);
            var textValue = $result.val();
            $result.remove();
            return commonHelper.htmlEncode(textValue);
        },

        editValue: function () {
            if (this.editControl.autoNumeric('get') === "") {
                return null;
            }
          
            return Number(this.editControl.autoNumeric('get'));
       },
...
(function (editGrid, $, undefined) {
    ...
    SelectField.prototype = new Field({
        itemTemplate: function (value) {
            ...
            return (result === undefined || result === null) ? "" : commonHelper.htmlEncode(result);
        },
...
(function (editGrid, $, undefined) {
    ...
    var validators = {
        required: {
            message: "You can’t leave this field blank.",
...
(function (editGrid, $, undefined) {
    ...
    SingleSuggestionField.prototype = new Field({
        ...
        itemTemplate: function (value) {
            return (value != null) ? commonHelper.htmlEncode(value.Name) : "";
        },
            ...
            $result.tokenInput(this.suggestionUrl,
                {
                    ...
                    minChars: this._minSuggestionChars,
        ...
        itemTemplate: function (value) {
            if (value != null) {
                ...
                for (var index = 0; index < value.length; index++) {
                    ...
                    displayData += commonHelper.htmlEncode(value.Name);
                }
        ...
        itemTemplate: function (value) {
            if (value != null) {
                ...
                for (var index = 0; index < value.length; index++) {
                    ...
                    displayData += commonHelper.htmlEncode(value[index].Name);
                }
