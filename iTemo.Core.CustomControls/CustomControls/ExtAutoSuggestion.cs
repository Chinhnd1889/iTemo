...
namespace iTemo.Core.CustomControls.CustomControls
{
    public static class ExtAutoSuggestion
    {
            ...
            object htmlAttributes = null)
        {
            ...
            var extBeforeSendRequestFunc = "extBeforeSendRequestFunc";
            ...
            var extSelectedCallbackFunc = "extSelectedCallbackFunc";
            ...
            var extChangedCallbackFunc = "extChangedCallbackFunc";
            ...
            var extPlaceholder = string.Empty;
            ...
            var extShowNoResultFound =
                html["extShowNoResultFound"] != null && html["extShowNoResultFound"].ToString() == "yes";
            ...
            var extNotFoundText = "No results found!";
            if (extShowNoResultFound)
            {
                ...
                var extNotFoundButtonText = "Create New";
                ...
                var extNotFoundButtonClickFunc = string.Empty;
            ...
            return new MvcHtmlString(htmlControl);
        }
    }
}
